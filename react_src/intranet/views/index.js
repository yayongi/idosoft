...
export {ModifyHistory as ModifyHistory} from './Project/History';		// 프로젝트 -> 프로젝트이력  -> 프로젝트추가
export {RegistHistory as RegistHistory} from './Project/History';// 프로젝트 -> 이력관리 등록
export {Manage as Manage} from './Project';						// 프로젝트 -> 프로젝트관리
export {ModifyProject as ModifyProject} from './Project/Modify';// 프로젝트 -> 이력관리 수정
