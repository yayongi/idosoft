...
export {default as MemberReg} from './Member/MemberReg';		// 사원등록 
export {default as MemberMod_admin} from './Member/MemberMod_admin';		// 사원상세_관리자 
export {default as MemberMod_user} from './Member/MemberMod_user';		// 사원상세_유 
