...
public class ProjectController {
	...
	public ModelAndView removeMember(HttpServletRequest request, @RequestBody Map<String, Object> params ){
		...
		try {
			...
			//차량 운행비가 있으면 삭제해준다.
			if((boolean) params.get("hasTrafficList")) {
				projectService.traffic_delete((HashMap<String, Object>)params);
			}
		}catch(Exception e) {
			LOG.debug("디비 에러남 DB ERROR");
			LOG.debug(e.toString());
	...
	@RequestMapping(value="/removeTraffic",method=RequestMethod.POST)
	@ResponseBody
	public ModelAndView removeTraffic(HttpServletRequest request, @RequestBody Map<String, Object> params ){
		ModelAndView mv = new ModelAndView();
	...
	@ResponseBody
	public ModelAndView updateTraffic(HttpServletRequest request, @RequestBody Map<String, Object> params ){
		ModelAndView mv = new ModelAndView();
		...
		boolean db_result = false;
		try {
			projectService.traffic_update((HashMap<String, Object>)params);
		}catch(Exception e) {
			LOG.debug("디비 에러남 DB ERROR");
			LOG.debug(e.toString());
			db_result = true;
